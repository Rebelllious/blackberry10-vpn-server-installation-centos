...
sed -i '/net.ipv4.ip_forward = 1/a net.ipv4.conf.default.proxy_arp = 1' /etc/sysctl.conf
sed -i '/net.ipv4.conf.default.proxy_arp = 1/a net.ipv4.conf.default.arp_accept = 1' /etc/sysctl.conf
